...
| US-12.10 | Pause panel **Commands** list shows `MOBILE_BINDINGS` labels (joystick, look zone, button names) instead of keyboard keys when touch-primary. Desktop list unchanged.                                                                                                                                 |
