...
1. **US-6** — shared animations + `remy` / `swat-1` + crouch-walk _(before US-4 weapon poses and pistol attach)_
2. **US-4** — PvP loop (round service + shooting; fire/reload clips on shared pack after US-6)
3. **US-7** — match select _(requires US-6 skins)_
4. **US-5** — Colyseus multiplayer
