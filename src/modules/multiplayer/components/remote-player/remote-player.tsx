...
import type { RemoteRenderTransform } from '@/modules/multiplayer/utils/step-remote-render-transform';
...
import { stepRemoteRenderTransform } from '@/modules/multiplayer/utils/step-remote-render-transform';
