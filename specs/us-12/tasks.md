...
- [x] Add `MOBILE_BINDINGS.cameraCycle` — `"Pause menu → Cycle camera"`; include in `MOBILE_COMMANDS`
- [x] `game-pause-panel.tsx` — show active camera mode label + **Cycle camera** button on main pause view; calls `cycleCameraMode()`
